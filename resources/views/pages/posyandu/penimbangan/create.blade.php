...
@section( 'main-container-header-title', "Masukkan Data Penimbangan" )
...
@section( 'main-container-breadcrumb' )
  ...
  <li class="active">Tambah Data Penimbangan Balita</li>
@endsection
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="glyphicon glyphicon-user"></i> Data Penimbangan Balita</h3>
        </div>
          {!! BootForm::open()->action( route( 'posyandu.penimbangan.store' ))!!}
          <div class="box-body">
              <div class="hidden"> 
