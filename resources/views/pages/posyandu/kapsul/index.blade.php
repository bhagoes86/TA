...
@section( 'main-container-header-title', "Data Pemberian Kapsul" )

@section( 'main-container-breadcrumb' )
  <li><a href="{!! route( 'posyandu' ) !!}"><i class="fa fa-dashboard"></i>Menu Utama</a></li>
  <li class="active">Data Pemberian Kapsul</li>
@endsection
                      ...
                      <td>
                        <div class="btn-group btn-group-justified">
                          <div class="btn-group" role="group">
                            <a href="{!! route( 'posyandu.balita.show', $kaps->id_balita ) !!}" class="btn btn-info">
