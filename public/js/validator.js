var validator = (function($){
    ...
    */
    message = {
        invalid         : 'data yang dimasukkan salah',
        checked         : 'periksa kembali',
        empty           : 'harus diisi',
        min             : 'input terlalu pendek',
        max             : 'input terlalu panjang ',
        number_min      : 'terlalu pendek',
        number_max      : 'terlalu panjang',
        url             : 'URL salah',
        number          : 'bukan angka',
        email           : 'alamat email salah',
        email_repeat    : 'email tidak cocok',
        password_repeat : 'password tidak cocok',
        repeat          : 'tidak ada data yang cocok',
        complete        : 'input tidak sempurna',
        select          : 'Silakan pilih salah satu'
    };
